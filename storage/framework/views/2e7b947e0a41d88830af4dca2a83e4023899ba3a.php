                        ...
                        <td data-label="<?php echo app('translator')->get('User'); ?>">
                            <a href="<?php echo e(route('admin.user-edit',$row->user_id)); ?>">
                                <div class="d-lg-flex d-block align-items-center ">
                                    <div class="mr-3"><img
                                            src="<?php echo e(getFile(config('location.user.path').optional($row->user)->image)); ?>"
                                            alt="user" class="rounded-circle" width="45"
                                            height="45"></div>
                                    <div class="">
                                        <h5 class="text-dark mb-0 font-16 font-weight-medium"><?php echo app('translator')->get(optional($row->user)->username); ?></h5>
                                        <p class="text-dark mb-0 font-10 font-weight-medium"><?php echo e(optional($row->user)->email); ?></p>
                                    </div>
                                </div>
                            </a>
                        </td>
                        <td data-label="<?php echo app('translator')->get('Amount'); ?>"> <span
                                class="font-weight-bold text-<?php echo e(($row->trx_type == "+") ? 'success': 'danger'); ?>"><?php echo e(($row->trx_type == "+") ? '+': '-'); ?><?php echo e(getAmount($row->amount,8). ' ' . $row->code); ?></span>
                        </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/admin/transaction/index.blade.php ENDPATH**/ ?>