...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="main row">
            <div class="col-12">
                <h5><?php echo app('translator')->get('Buy'); ?> - <?php echo e($currencyCode ? strtoupper($currencyCode):'Crypto'); ?></h5>
                <div class="tab-section">
                    <div class="switcher navigator">
                        <a href="<?php echo e(route('user.buyCurrencies.list','all')); ?>"
                           class="buy tab text-uppercase <?php echo e((last(request()->segments())=='all')?'active':''); ?>"><?php echo app('translator')->get('All'); ?></a>
                        <?php $__empty_1 = true; $__currentLoopData = $buyCurrencyLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('user.buyCurrencies.list',[@slug(optional($item->cryptoCurrency)->code),$item->crypto_id])); ?>"
                               class="buy tab text-uppercase <?php echo e((last(request()->segments())==$item->crypto_id)?'active':''); ?>"><?php echo e(optional($item->cryptoCurrency)->code); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="search-bar">
                    <form action="<?php echo e(route('user.buyCurrencies.list')); ?>" method="get">
        ...
        <div class="table-parent table-responsive">
            <table class="table table-striped" id="service-table">
                ...
                <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $buyLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td data-label="<?php echo app('translator')->get('Action'); ?>" class="action">
                            <a href="<?php echo e(route('user.buyCurrencies.tradeRqst',$item->id)); ?>"
                               class="btn-custom buy-currency p-6">
                                <?php echo app('translator')->get('Buy '); ?><?php echo e($item->cryptoCurrency->code); ?></a>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php echo e($buyLists->appends($_GET)->links($theme.'partials.pagination')); ?>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/themes/peerToPeer/user/buy/list.blade.php ENDPATH**/ ?>