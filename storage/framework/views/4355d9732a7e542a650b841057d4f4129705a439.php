                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                                ...
                                <a href="<?php echo e(route('admin.user-edit',$item->user_id )); ?>">
                                    <div class="d-flex no-block align-items-center">
                                        ...
                                        <div class="mr-3">
                                            ...
                                            <span
                                                class="text-muted font-14"><?php echo e(optional($item->user)->email); ?></span>
                                        </div>
                                    </div>
                                </a>
                            </td>
                            ...
                            <td data-label="<?php echo app('translator')->get('Amount'); ?>"
                                class="font-weight-bold"><?php echo e(getAmount($item->amount,8)); ?> <?php echo e($item->code); ?></td>
                            <td data-label="<?php echo app('translator')->get('Charge'); ?>"
                                class="text-danger"><?php echo e(getAmount($item->charge,8)); ?> <?php echo e($item->code); ?></td>
                            <td data-label="<?php echo app('translator')->get('Net Amount'); ?>"
                                class="font-weight-bold"><?php echo e(getAmount($item->net_amount,8)); ?> <?php echo e($item->code); ?></td>
                                ...
                                <?php if(Request::routeIs('admin.payout-request')): ?>
                                    <td data-label="<?php echo app('translator')->get('More'); ?>">
                                        ...
                                        <button type="button" class="btn btn-primary btn-icon edit_button"
                                                ...
                                                data-method="<?php echo e($item->method->name); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/admin/payout/logs.blade.php ENDPATH**/ ?>