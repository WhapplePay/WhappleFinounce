...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        <div class="main row">
            <div class="col-12">
                <h5><?php echo app('translator')->get('Sell'); ?> - <?php echo e($currencyCode ? strtoupper($currencyCode):'Crypto'); ?></h5>
                <div class="tab-section">
                    <div class="switcher navigator">
                        <a href="<?php echo e(route('user.sellCurrencies.list','all')); ?>"
                           class="sell tab text-uppercase <?php echo e((last(request()->segments())=='all')?'active':''); ?>"><?php echo app('translator')->get('All'); ?></a>
                        <?php $__empty_1 = true; $__currentLoopData = $sellCurrencyLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <a href="<?php echo e(route('user.sellCurrencies.list',[@slug(optional($item->cryptoCurrency)->code),$item->crypto_id])); ?>"
                               class="sell tab text-uppercase <?php echo e((last(request()->segments())==$item->crypto_id)?'active':''); ?>"><?php echo e(optional($item->cryptoCurrency)->code); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <?php endif; ?>
                    </div>
                </div>
                <div class="search-bar">
                    <form action="<?php echo e(route('user.sellCurrencies.list')); ?>" method="get">
        ...
        <div class="table-parent table-responsive">
            <table class="table table-striped" id="service-table">
                ...
                <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $sellLists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                            ...
                            <a href="<?php echo e(route('user.profile.page',$item->user_id)); ?>">
                                <div class="d-lg-flex d-block align-items-center">
                                    <div class="me-3"><img
                                            ...
                                            height="45">
                                        <i class="tb-online position-absolute fa fa-circle text-<?php echo e((optional($item->user)->lastSeen == true) ?trans('success'):trans('danger')); ?>"
                                           title="<?php echo e((optional($item->user)->lastSeen == true) ?trans('Online'):trans('Away')); ?>"></i>
                                    </div>
                                    <div class="">
                                        ...
                                        <?php if(optional($item->user)->total_trade > 0): ?>
                                            <span
                                                class="text-muted font-10"><?php echo app('translator')->get('Completion'); ?> <?php echo e(number_format(optional($item->user)->completed_trade*100/optional($item->user)->total_trade,2)); ?> %</span>
                                        <?php else: ?>
                                            <span
                                                class="text-muted font-10"><?php echo app('translator')->get('Completion'); ?> 0 %</span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </a>
                        ...
                        <td data-label="<?php echo app('translator')->get('Rate'); ?>"><?php echo app('translator')->get(number_format($item->rate,2)); ?> <?php echo e(optional($item->fiatCurrency)->code); ?>
                        ...
                        <td data-label="<?php echo app('translator')->get('Limit'); ?>"><?php echo e($item->minimum_limit); ?> <?php echo e(optional($item->fiatCurrency)->code); ?>
                        ...
                        <td data-label="<?php echo app('translator')->get('Action'); ?>" class="action">
                            <a href="<?php echo e(route('user.sellCurrencies.tradeRqst',$item->id)); ?>"
                               class="btn-custom sell-currency p-6">
                                <?php echo app('translator')->get('Sell '); ?><?php echo e($item->cryptoCurrency->code); ?></a>
                        </td>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <tr>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <?php echo e($sellLists->appends($_GET)->links($theme.'partials.pagination')); ?>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/themes/peerToPeer/user/sell/list.blade.php ENDPATH**/ ?>