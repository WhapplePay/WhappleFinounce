<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('In App Notification'); ?>
                        ...
                        <div class="row my-3">
                            <div class="form-group col-sm-4 col-12">
                                ...
                                <input type="text" name="PUSHER_APP_ID"
                                       value="<?php echo e(old('PUSHER_APP_ID',env('PUSHER_APP_ID'))); ?>"
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-sm-4 col-12">
                                ...
                                <input type="text" name="PUSHER_APP_SECRET"
                                       value="<?php echo e(old('PUSHER_APP_SECRET',env('PUSHER_APP_SECRET'))); ?>"
                                       required="required"
                                       class="form-control ">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-sm-4 col-12">
                                ...
                                <input type="text" name="PUSHER_APP_CLUSTER"
                                       value="<?php echo e(old('PUSHER_APP_CLUSTER',env('PUSHER_APP_CLUSTER'))); ?>"
                                       required="required"
                                       class="form-control ">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group col-sm-4  col-12">
                                <label class="font-weight-bold"><?php echo app('translator')->get('In App Notification'); ?></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/admin/notify/controls.blade.php ENDPATH**/ ?>