            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo app('translator')->get('Trade Limit For Ad'); ?></th>
                                ...
                                <a href="<?php echo e(route('admin.user-edit',$user->id)); ?>">
                                    <div class="d-lg-flex d-block align-items-center ">
                                        <div class="mr-3"><img
                                                ...
                                                height="45"></div>
                                        <div class="">
                                            <h5 class="text-dark mb-0 font-16 font-weight-medium"><?php echo app('translator')->get($user->fullname); ?></h5>
                                            <p class="text-dark mb-0 font-10 font-weight-medium"><?php echo e($user->email); ?></p>
                                        </div>
                                    </div>
                                </a>
                            </td>
                            <td data-label="<?php echo app('translator')->get('Trade Limit For Ad'); ?>"><?php echo e($user->mobile); ?></td>
                            <td data-label="<?php echo app('translator')->get('Trade Limit For Ad'); ?>">
                                <span
                                    class="badge badge-info"><?php echo e($user->trade_limit??config('basic.incompleteLimit')); ?></span>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/admin/users/list.blade.php ENDPATH**/ ?>