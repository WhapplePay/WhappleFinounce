        ...
        <div class="container-fluid">
            <div class="main row">
                <section class="buy-coin-section">
                    <div class="row g-4">
                        <div class="col-12">
                            <h4><?php echo app('translator')->get('Buy'); ?> <?php echo e(optional($advertisment->cryptoCurrency)->name); ?>

                                <?php echo app('translator')->get('using'); ?> <?php $__currentLoopData = $advertisment->gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class="gateway-color text-base"
                                          style="border-left-color: <?php echo e($gateway->color); ?>"><?php echo e($gateway->name); ?></span>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?> <?php echo app('translator')->get('with'); ?> <?php echo e(optional($advertisment->fiatCurrency)->name); ?>

                                ( <?php echo e(optional($advertisment->fiatCurrency)->code); ?> )</h4>
                            <p><a href="<?php echo e(route('user.profile.page',$advertisment->user_id)); ?>"
                                  class="theme-color"><?php echo e(optional($advertisment->user)->username); ?></a> <?php echo app('translator')->get('wishes to sell to you.'); ?>
                            </p>
                        </div>
                        <div class="col-lg-8">
                            <div class="rate">
                            ...
                            <div class="trade-request">
                                <h5 class="text-center mb-4"><?php echo app('translator')->get('How much you wish to buy?'); ?></h5>
                                <form action="<?php echo e(route('user.buyCurrencies.trade.send')); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="advertiseId" value="<?php echo e($advertisment->id); ?>">
                                    <div class="row g-3">
                                        <div class="input-box col-md-6">
                                            <label for=""><?php echo app('translator')->get('I will pay'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-lg-4">
                            <div class="side-bar">
                                ...
                                <div>
                                    <h5><i class="fal fa-file-spreadsheet"></i> <?php echo app('translator')->get('Terms of this trade'); ?></h5>
                                    <p>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/themes/peerToPeer/user/buy/trade.blade.php ENDPATH**/ ?>