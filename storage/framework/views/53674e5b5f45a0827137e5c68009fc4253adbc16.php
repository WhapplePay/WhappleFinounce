<?php $__env->startSection('title', trans('Sell')); ?>
<?php $__env->startSection('content'); ?>
    <!-- buy sell -->
    <section class="buy-sell">
        <div class="container">
            <div class="search-bar">
                <form action="<?php echo e(route('sell')); ?>" method="get">
                                        ...
                                        <a href="<?php echo e(route('user.profile.page',$item->user_id)); ?>">
                                            <div class="d-lg-flex d-block align-items-center">
                                                ...
                                                <div class="">
                                                    ...
                                                    <?php else: ?>
                                                        <span class="text-muted font-10"><?php echo app('translator')->get('Completion'); ?> 0%</span>
                                                    <?php endif; ?>
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Payment Method'); ?>">
                                        <div class="d-flex flex-wrap">
                                            <?php $__currentLoopData = $item->gateways; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gateway): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <a href="<?php echo e(route('sell',$gateway->id)); ?>"><span class="gateway-color"
                                                                                               style="border-left-color: <?php echo e($gateway->color); ?>"><?php echo e($gateway->name); ?>
...
<?php echo $__env->make($theme.'layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/themes/peerToPeer/sell.blade.php ENDPATH**/ ?>