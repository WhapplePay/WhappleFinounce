                                        ...
                                        <div class="col-lg-8 col-md-12 mt-md-2">
                                            <div class="submit-btn">
                                                <button type="submit" name="replayTicket" value="1"
                                                        ...
                                                        class="fas fa-paper-plane"></i> <?php echo e(trans('Reply')); ?>
                                            ...
                                            <li class="chat-item list-style-none replied mt-3 text-right">
                                                ...
                                                <div class="w-100" align="right">
                                                    <div class="chat-content d-inline-block pr-3">
                                                        <h6 class="font-weight-medium me-2"><?php echo e(optional($ticket->user)->username); ?> </h6>
                                                        ...
                                                        <?php endif; ?>
                                                        <div
                                                            class="chat-time me-2"><?php echo e(dateTime($item->created_at, 'd M, y h:i A')); ?>
                                            ...
                                            <li class="chat-item list-style-none mt-3">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="chat-content d-inline-block pl-3">
                                                        <h6 class="font-weight-medium ms-2"><?php echo e(optional($item->admin)->name); ?></h6>
                                                        <div class="media">
                                                        ...
                                                        <?php endif; ?>
                                                        <div
                                                            class="chat-time d-block font-10 mt-0 mr-0 mb-3 ms-2"><?php echo e(dateTime($item->created_at, 'd M, y h:i A')); ?></div>
                                                    </div>
...
<?php echo $__env->make($theme.'layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/themes/peerToPeer/user/support/view.blade.php ENDPATH**/ ?>