<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Edit Fiat Currency'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <form action="<?php echo e(route('admin.updateFiat',$fiat->id)); ?>" class="form-row justify-content-center" method="post"
                    ...
                    <div class="row ">
                        <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" value="<?php echo e($fiat->name); ?>"
                                       class="form-control" placeholder="<?php echo app('translator')->get('eg. American Dollar, Indian Rupee'); ?>"
                                       required>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="code" value="<?php echo e($fiat->code); ?>"
                                       placeholder="<?php echo app('translator')->get('eg. USD, INR'); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class=" col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="symbol" value="<?php echo e($fiat->symbol); ?>"
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span
                                        class="input-group-text"><?php echo app('translator')->get('1 USD'); ?><?php echo app('translator')->get(' = '); ?></span>
                                </div>
                                <input type="text" name="rate" value="<?php echo e($fiat->rate); ?>" class="form-control"
                                       placeholder="0" required>
                                <div class="input-group-append">
                                    <span class="input-group-text currencyReserveSign"><?php echo app('translator')->get($fiat->code); ?></span>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="deposit_charge"
                                       class="form-control"
                                       value="<?php echo e($fiat->deposit_charge); ?>">
                                <div class="input-group-append">
                                    <select class="form-control  mb-3" name="deposit_type"
                                            aria-label=".form-select-lg example">
                                        <option value="1" <?php if($fiat->deposit_type==0): ?> selected
                                                <?php endif; ?> class="minMaxCurrency"><?php echo app('translator')->get($fiat->code); ?></option>
                                        <option value="0" <?php if($fiat->deposit_type==1): ?> selected <?php endif; ?>>%</option>
                                    </select>
                                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <input type="text" name="withdraw_charge"
                                       class="form-control"
                                       value="<?php echo e($fiat->withdraw_charge); ?>">
                                <div class="input-group-append">
                                    <select class="form-control  mb-3" name="withdraw_type"
                                            aria-label=".form-select-lg example">
                                        <option value="1" <?php if($fiat->withdraw_type==0): ?> selected
                                                <?php endif; ?> class="minMaxCurrency"><?php echo app('translator')->get($fiat->code); ?></option>
                                        <option value="0" <?php if($fiat->withdraw_type==1): ?> selected <?php endif; ?>>%</option>
                                    </select>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="image-input ">
                                    ...
                                    <img id="image_preview_container" class="preview-image"
                                         src="<?php echo e(getFile(config('location.currency.path').$fiat->image)); ?>"
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input data-toggle="toggle" id="status" data-onstyle="success"
                                           ...
                                           type="checkbox" <?php if($fiat->status == 1): ?> checked <?php endif; ?>  name="status">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/whapplecoins/resources/views/admin/currency/fiat/edit.blade.php ENDPATH**/ ?>