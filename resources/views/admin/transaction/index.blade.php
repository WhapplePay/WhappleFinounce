                            ...
                            <a href="{{route('admin.user-edit',$row->user_id)}}">
                                <div class="d-lg-flex d-block align-items-center ">
                                    ...
                                    <div class="">
                                        ...
                                        <p class="text-dark mb-0 font-10 font-weight-medium">{{optional($row->user)->email}}</p>
                                    </div>
                                </div>
                            </a>
                        </td>
                        <td data-label="@lang('Amount')"> <span
                                class="font-weight-bold text-{{($row->trx_type == "+") ? 'success': 'danger'}}">{{($row->trx_type == "+") ? '+': '-'}}{{getAmount($row->amount,8). ' ' . $row->code}}</span>
                        </td>
