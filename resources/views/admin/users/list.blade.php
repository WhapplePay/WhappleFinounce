            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered">
                    ...
                    <tr>
                        ...
                        <th scope="col">@lang('Trade Limit For Ad')</th>
                                ...
                                <a href="{{route('admin.user-edit',$user->id)}}">
                                    <div class="d-lg-flex d-block align-items-center ">
                                        ...
                                        <div class="">
                                            ...
                                            <p class="text-dark mb-0 font-10 font-weight-medium">{{$user->email}}</p>
                                        </div>
                                    </div>
                                </a>
                            </td>
                            <td data-label="@lang('Trade Limit For Ad')">{{$user->mobile}}</td>
                            <td data-label="@lang('Trade Limit For Ad')">
                                <span
                                    class="badge badge-info">{{$user->trade_limit??config('basic.incompleteLimit')}}</span>
                            </td>
