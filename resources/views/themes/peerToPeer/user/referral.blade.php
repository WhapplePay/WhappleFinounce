                ...
                <div class="row justify-content-between ">
                    <div class="col-md-4">
                        <div class="search-bar">
                            <h5 class="title text-start mb-3">@lang('Referral link')</h5>
                            <p>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group input-box">
                                            ...
                                            <div class="input-group-append">
                                                <button title="copy"><span class="input-group-text form-control copytext"
                                                              id="copyBoard"
                    ...
                    <div class="col-md-8">
                        @if(0 < count($referrals))
                            <div class="search-bar">
                                <h5 class="title text-start mb-3">@lang('Referral Members')</h5>
                                <div class="d-flex justify-content-start flex-column flex-wrap" id="ref-label">
                                    <div class="nav w-sm-100 nav-pills mx-2 d-flex flex-wrap" id="v-pills-tab"
                                         role="tablist"
                                         aria-orientation="vertical">
                                        @foreach($referrals as $key => $referral)
                                            <a class=" nav-link @if($key == '1')   active  @endif color "
                                               id="v-pills-{{$key}}-tab" href="javascript:void(0)"
                                               data-bs-toggle="pill"
                                    ...
                                    <div class="tab-content w-sm-100" id="v-pills-tabContent">
                                        @foreach($referrals as $key => $referral)
                                            <div class="tab-pane fade @if($key == '1') show active  @endif "
                                                ...
                                                @if( 0 < count($referral))
                                                    <div class="table-parent table-responsive mt-3">
