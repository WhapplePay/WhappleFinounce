                                        ...
                                        <a href="{{route('user.profile.page',$item->user_id)}}">
                                            <div class="d-lg-flex d-block align-items-center">
                                                ...
                                                <div class="">
                                                    ...
                                                    @else
                                                        <span class="text-muted font-10">@lang('Completion') 0%</span>
                                                    @endif
                                                </div>
                                            </div>
                                        </a>
                                    ...
                                    <td data-label="@lang('Payment Method')">
                                        <div class="d-flex flex-wrap">
                                            @foreach($item->gateways as $gateway)
                                                <a href="{{route('sell',$gateway->id)}}"><span class="gateway-color"
                                                                                               style="border-left-color: {{$gateway->color}}">{{$gateway->name}}
                                                    </span></a>
                                            @endforeach
                                        </div>
                                    </td>
