...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected $appends = ['fullname', 'mobile', 'imgPath', 'last_seen', 'total_trade'];
    ...
    {
        $totalTrade = Trade::where('sender_id', $this->id)->orWhere('owner_id', $this->id)->count();
        return $totalTrade;
    }
    ...
    {
        return $this->morphMany(TradeChat::class, 'chatable');
    }
    ...
    {
        return $this->hasMany(Advertisment::class, 'user_id', 'id')->orderBy('id', 'desc');
    }
}
